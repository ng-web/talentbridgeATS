                ...
                <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px; width:100%;">
                    ...
                    <tr>
                        <td style="background:#ffffff; padding:40px; border-radius:0 0 12px 12px; border:1px solid #e5e7eb; border-top:none;">
                            ...
                            <h2 style="margin:0 0 20px; font-size:22px; font-weight:700; color:#111827;">You have a new applicant</h2>

                            <p style="margin:0 0 20px; color:#1f2937; font-size:15px; line-height:1.7;">
                                Hi {{ $application->job->employer->user->name ?? $application->job->employer->company_name }},
                            </p>

                            <p style="margin:0 0 20px; color:#1f2937; font-size:15px; line-height:1.7;">
                                A candidate has submitted an application for one of your active listings on Kairox Exchange.
                            </p>
                            ...
                            <div style="background:#f9fafb; border:1px solid #e5e7eb; border-left:4px solid #6f4cb2; border-radius:6px; padding:16px 20px; margin:0 0 24px;">
                                <p style="margin:0 0 12px; font-size:12px; color:#6b7280; text-transform:uppercase; letter-spacing:0.06em; font-weight:600;">Application Details</p>

                                <table cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td style="font-size:13px; color:#6b7280; padding-bottom:6px; width:120px;">Applicant</td>
                                        <td style="font-size:14px; color:#111827; font-weight:600; padding-bottom:6px;">{{ $application->jobSeeker->user->name }}</td>
                                    </tr>
                                    <tr>
                                        <td style="font-size:13px; color:#6b7280; padding-bottom:6px;">Position</td>
                                        <td style="font-size:14px; color:#111827; font-weight:600; padding-bottom:6px;">{{ $application->job->title }}</td>
                                    </tr>
                                    <tr>
                                        <td style="font-size:13px; color:#6b7280;">Applied</td>
                            ...
                            <p style="margin:0 0 28px; color:#1f2937; font-size:15px; line-height:1.7;">
                                Log in to your dashboard to review the submitted resume and cover letter, and update the applicant's status as you move through your selection process.
                            </p>
